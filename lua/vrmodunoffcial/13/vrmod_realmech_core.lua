...
CreateClientConVar("vrmod_unoff_realmech_slide_enable", "0", true, false, "Enable slide blowback animation")
CreateClientConVar("vrmod_unoff_realmech_trigger_enable", "0", true, false, "Enable trigger pull animation")
CreateClientConVar("vrmod_unoff_realmech_bullet_enable", "0", true, false, "Enable bullet bone visibility")
CreateClientConVar("vrmod_unoff_realmech_hammer_enable", "0", true, false, "Enable hammer animation")
CreateClientConVar("vrmod_unoff_realmech_selector_enable", "0", true, false, "Enable fire selector animation")
...
CreateClientConVar("vrmod_unoff_realmech_slide_grab_enable", "0", true, false, "Enable VR slide grab")
...
CreateClientConVar("vrmod_unoff_realmech_reload_idle_return", "0", true, false, "On vrmagent pickup: 1=return to idle (pistol), 0=keep frozen pose (revolver/break-action)")
...
timer.Simple(0, function()
    if VRMOD_DEFAULTS then
        VRMOD_DEFAULTS["realmech"] = {
            ...
            vrmod_unoff_realmech_slide_enable = 0,
            vrmod_unoff_realmech_trigger_enable = 0,
            vrmod_unoff_realmech_bullet_enable = 0,
            vrmod_unoff_realmech_hammer_enable = 0,
            vrmod_unoff_realmech_selector_enable = 0,
            vrmod_unoff_realmech_slide_speed = 15,
            vrmod_unoff_realmech_blowback = 2.5,
            vrmod_unoff_realmech_trigger_angle = 15,
            vrmod_unoff_realmech_slide_grab_enable = 0,
            ...
            vrmod_unoff_realmech_reload_idle_return = 0,
