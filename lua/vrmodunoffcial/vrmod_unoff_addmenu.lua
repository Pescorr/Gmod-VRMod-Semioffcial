...
if menutype1:GetBool() then
	hook.Add(
		...
		function(frame)
			...
			sheet:AddSheet("Graphics Settings", graphicsSettings, "icon16/picture.png")
			...
			sheet:AddSheet("Gameplay Settings", gameplaySettings, "icon16/controller.png")
			...
			sheet:AddSheet("General Settings", generalSettings, "icon16/cog.png")
			...
			sheet:AddSheet("UI Settings", uiSettings, "icon16/application_view_tile.png")
			...
			weaponmenuattach:AddChoice("Right Hand", "2")
			...
			popupattach:AddChoice("Right Hand", "2")
			...
			sheet:AddSheet("Network Settings (Server)", networkSettings, "icon16/connect.png")
			...
			sheet:AddSheet("Advanced Settings", advancedSettings, "icon16/wrench.png")
			...
			sheet:AddSheet("Quick Menu Settings", quickMenuSettings, "icon16/lightning.png")
