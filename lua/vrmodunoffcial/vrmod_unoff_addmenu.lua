...
hook.Add(
	...
	function(frame)
		...
		vrmod_mapbrowser:SetPos(20, 220) -- Set the position
		...
		vrmod_quickmenu_exit:SetPos(20, 265) -- Set the position
		...
		--DCheckBoxLabel end
		--DCheckBoxLabel Start
		local vrmod_vgui_reset_menu = Panel3:Add("DCheckBoxLabel") -- Create the checkbox
		vrmod_vgui_reset_menu:SetPos(20, 310) -- Set the position
		...
		-- If not using convars, you can use this hook + Panel.SetValue()
		storedframes.OnValueChanged = function(self, value) end -- Called when the slider value changes
		--DNumSlider end
		--DCheckBoxLabel Start
