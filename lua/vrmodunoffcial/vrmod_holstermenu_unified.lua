...
hook.Add(
	...
	function(frame)
		...
		-- Slot 1
		local slot1Category = form2:Help("=== Slot 1 ===")
		slot1Category:SetFont("DermaDefaultBold")
		form2:TextEntry("Weapon/Entity (Read-only)", "vrmod_pouch_weapon_1")
		form2:NumSlider("Size", "vrmod_pouch_size_1", 0, 50, 1)

		-- Slot 2
		local slot2Category = form2:Help("=== Slot 2 ===")
		slot2Category:SetFont("DermaDefaultBold")
		form2:TextEntry("Weapon/Entity (Read-only)", "vrmod_pouch_weapon_2")
		form2:NumSlider("Size", "vrmod_pouch_size_2", 0, 50, 1)

		-- Slot 3
		local slot3Category = form2:Help("=== Slot 3 ===")
		slot3Category:SetFont("DermaDefaultBold")
		form2:TextEntry("Weapon/Entity (Read-only)", "vrmod_pouch_weapon_3")
		form2:NumSlider("Size", "vrmod_pouch_size_3", 0, 50, 1)

		-- Slot 4
		local slot4Category = form2:Help("=== Slot 4 ===")
		slot4Category:SetFont("DermaDefaultBold")
		form2:TextEntry("Weapon/Entity (Read-only)", "vrmod_pouch_weapon_4")
		form2:NumSlider("Size", "vrmod_pouch_size_4", 0, 50, 1)

		-- Slot 5
		local slot5Category = form2:Help("=== Slot 5 ===")
		slot5Category:SetFont("DermaDefaultBold")
		form2:TextEntry("Weapon/Entity (Read-only)", "vrmod_pouch_weapon_5")
		form2:NumSlider("Size", "vrmod_pouch_size_5", 0, 50, 1)
