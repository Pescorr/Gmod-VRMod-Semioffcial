	...
	local function ToggleKeyboard()
		...
		local function updateKeyboard()
			for i = 1, #selectedCase do
				if selectedCase[i] == "\n" then continue end
				keys[i]:SetText(selectedCase[i] == "\1" and "Back" or selectedCase[i] == "\2" and "Enter" or selectedCase[i] == "\4" and "Shift" or selectedCase[i] == "\3" and "tex" or selectedCase[i])
			end
		end
		...
		for i = 1, #selectedCase do
			...
			key:SetText(selectedCase[i] == "\1" and "Back" or selectedCase[i] == "\2" and "Enter" or selectedCase[i] == "\4" and "Shift" or selectedCase[i] == "\3" and "tex" or selectedCase[i])
