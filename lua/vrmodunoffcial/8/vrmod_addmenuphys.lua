...
hook.Add(
	...
	function(frame)
		...
		sheet:AddSheet("General", MenuTabGeneral, "icon16/cog.png")
		MenuTabGeneral.Paint = function(self, w, h) end
		local titleGeneral = vgui.Create("DLabel", MenuTabGeneral)
		titleGeneral:SetText("VR Physgun General Settings")
		titleGeneral:SetFont("DermaDefaultBold")
		titleGeneral:SetTextColor(Color(0, 0, 0))
		titleGeneral:SetPos(20, 10)
		titleGeneral:SizeToContents()
		local compatMode = vgui.Create("DCheckBoxLabel", MenuTabGeneral)
		compatMode:SetText("VRPICKUP Compatibility Mode (Use Physgun instead of VR Pickup)")
		compatMode:SetConVar("vrmod_unoff_physgun_pickup_compat")
		compatMode:SetPos(20, 40)
		compatMode:SizeToContents()
		local compatDesc = vgui.Create("DLabel", MenuTabGeneral)
		compatDesc:SetText("Disables VR Pickup grip input and uses Physgun beams for all grabbing.")
		compatDesc:SetTextColor(Color(100, 100, 100))
		compatDesc:SetPos(20, 65)
		compatDesc:SetSize(370, 20)
