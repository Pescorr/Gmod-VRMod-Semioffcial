...
local crosshairHudOffsetPos = Vector(0, 13.6, 7.6) -- Vector(0, 13.6, 7.6) -- 銃口基準の場合、(0,0,0) から調整開始が推奨
local crosshairHudOffsetAng = Angle(0, -90, 90) -- Angle(0, -90, 90)   -- 銃口基準の場合、(0,0,0) から調整開始が推奨
local crosshairHudScale = 0.03
local crosshairHudRenderWidth = 512
local crosshairHudRenderHeight = 512
...
local function RenderCrosshairHudInSpace()
    ...
    -- ソースとなるレンダーターゲットのサイズ
    local rtSourceWidth = 1366
    local rtSourceHeight = 768
