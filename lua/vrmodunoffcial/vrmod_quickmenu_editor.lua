...
function PANEL:Init()
    ...
    self.moveUpBtn:SetText(L("Up", "Up"))
    ...
    self.moveDownBtn:SetText(L("Down", "Down"))
...
function PANEL:OpenItemDialog(editIndex)
    ...
    slotLabel:SetText(L("Slot (0-5):", "Slot (0-5):"))
    ...
    posLabel:SetText(L("Position (0-9):", "Position (0-9):"))
