...
local vrmod_cmd_spawnmenu_open = CreateClientConVar("vrmod_cmd_spawnmenu_open", "+menu",true,FCVAR_ARCHIVE)
local vrmod_cmd_spawnmenu_close = CreateClientConVar("vrmod_cmd_spawnmenu_close", "-menu",true,FCVAR_ARCHIVE)
local vrmod_cmd_contextmenu_open = CreateClientConVar("vrmod_cmd_contextmenu_open", "+menu_context",true,FCVAR_ARCHIVE)
local vrmod_cmd_contextmenu_close = CreateClientConVar("vrmod_cmd_contextmenu_close", "-menu_context",true,FCVAR_ARCHIVE)
local vr_mapbrowser_enable = CreateClientConVar("vrmod_quickmenu_mapbrowser_enable", "1",true,FCVAR_ARCHIVE)
local shutdownbutton = CreateClientConVar("vrmod_quickmenu_exit", "1",true,FCVAR_ARCHIVE)
local seated_menu = CreateClientConVar("vrmod_quickmenu_seated_menu", "1",true,FCVAR_ARCHIVE)
local vguireset = CreateClientConVar("vrmod_quickmenu_vgui_reset_menu", "0",true,FCVAR_ARCHIVE)
local vre_gbradial_menu = CreateClientConVar("vrmod_quickmenu_vre_gbradial_menu", "1",true,FCVAR_ARCHIVE)
local vrmod_quickmenu_chat = CreateClientConVar("vrmod_quickmenu_chat", "1",true,FCVAR_ARCHIVE)
local vrmod_togglemirror = CreateClientConVar("vrmod_quickmenu_togglemirror", "1",true,FCVAR_ARCHIVE)
local vrmod_quickmenu_togglevehiclemode = CreateClientConVar("vrmod_quickmenu_togglevehiclemode", "1",true,FCVAR_ARCHIVE)
local vrmod_quickmenu_noclip = CreateClientConVar("vrmod_quickmenu_noclip", "1",true,FCVAR_ARCHIVE)
local spawn_menu = CreateClientConVar("vrmod_quickmenu_spawn_menu", "1",true,FCVAR_ARCHIVE)
local context_menu = CreateClientConVar("vrmod_quickmenu_context_menu", "1",true,FCVAR_ARCHIVE)
local vrmod_quickmenu_arccw = CreateClientConVar("vrmod_quickmenu_arccw", "0",true,FCVAR_ARCHIVE)
local button1on = 0
local button2on = 0
hook.Add(
    "VRMod_OpenQuickMenu",
