            ...
            function(action, pressed)
                ...
                elseif action == "boolean_changeweapon" then
                    if pressed then
                        ...
                        if lvsselectwep_special == 0 then
                            lvsselectwep_special = 1
                            weaponToSelect = 1
                        elseif lvsselectwep_special == 1 then
                            lvsselectwep_special = 2
                            weaponToSelect = 2
                        elseif lvsselectwep_special == 2 then
                            lvsselectwep_special = 3
                            weaponToSelect = 3
                        elseif lvsselectwep_special == 3 then
                            lvsselectwep_special = 4
                            weaponToSelect = 4
                        elseif lvsselectwep_special == 4 then
                            lvsselectwep_special = 0
                            weaponToSelect = -1
                        end
