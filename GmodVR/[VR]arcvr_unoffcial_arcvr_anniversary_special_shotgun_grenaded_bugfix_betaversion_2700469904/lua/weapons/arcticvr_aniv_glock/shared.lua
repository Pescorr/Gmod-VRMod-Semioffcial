...
SWEP.ViewModel = "models/weapons/arcticvr/aniv/pistol_glock.mdl"
...
SWEP.FingerAngles = {
    ...
    Angle(-10,0.6,0), Angle(0,-60,0), Angle(0,-57,0), --finger 2
    Angle(-10,0.8,0), Angle(0,-50,0), Angle(0, -60.1,0), --finger 3
    Angle(-10,0.3,-8.2), Angle(0,-50,0), Angle(0,-30.5,0), --finger 4
    --right hand closed angles
    Angle(-0,-7,-5), Angle(0,40,0), Angle(0,10,0), --finger 0
    Angle(-10,35,17), Angle(0,-5,0), Angle(0,-40.9,0), --finger 1   This is the index finger, on the trigger
    Angle(-10,0.6,0), Angle(0,-60,0), Angle(0,-57,0), --finger 2
    Angle(-10,0.8,0), Angle(0,-50,0), Angle(0, -60.1,0), --finger 3
    Angle(-10,0.3,-8.2), Angle(0,-50,0), Angle(0,-30.5,0), --finger 4
}
...
SWEP.FireSelectPoses = {
    [1] = {
        selector = {pos = Vector(0, 0, 0), ang = Angle(0, 0, 40)}
    },
    [-3] = {
