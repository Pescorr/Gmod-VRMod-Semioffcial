...
SWEP.ViewModel = "models/weapons/arcticvr/aniv/smg_mac10.mdl"
...
SWEP.MagType = "mac10"
SWEP.DefaultMagazine = "mac10_32_aniv"
...
g_VR.viewModelInfo.arcticvr_aniv_mac10 = {
...
SWEP.FingerAngles = {
    ...
    Angle(-0,-7,-5), Angle(0,40,0), Angle(0,10,0), --finger 0
    Angle(0,35,17), Angle(0,-15,0), Angle(0,-55.9,0), --finger 1   This is the index finger, on the trigger
    Angle(0,10.6,0), Angle(0,-60,0), Angle(0,-47,0), --finger 2
    Angle(0,10.8,0), Angle(0,-40,0), Angle(0, -60.1,0), --finger 3
    Angle(0,10.3,-8.2), Angle(0,-40,0), Angle(0,-30.5,0), --finger 4
}
...
SWEP.SlideLockbackAmount = 2.1
SWEP.SlideBlowbackAmount = 2.8
