...
scripted_ents.Register(
	{
		Type = "anim",
		Base = "vrmod_pickup_retry"
	}, "vrmod_pickup_retry"
)

local _, convarValues = vrmod.GetConvars()
vrmod.AddCallbackedConvar("vrmod_pickup_limit", nil, 0, FCVAR_REPLICATED + FCVAR_ARCHIVE, "", 0, 3, tonumber) --cvarName, valueName, defaultValue, flags, helptext, min, max, conversionFunc, callbackFunc
