...
-- end)
	...
	concommand.Add( "vrmod_gmod_optimization_old", function( ply, cmd, args )
	...
	concommand.Add( "vrmod_gmod_optimization", function( ply, cmd, args )
		...
		LocalPlayer():ConCommand("r_mapextents 8000")
			print("r_mapextents 8000")
		LocalPlayer():ConCommand("mat_wateroverlaysize 0.00")
			print("mat_wateroverlaysize 0.00")
