...
local rt = GetRenderTargetEx("vrmod_hud", vrScrW:GetInt(), vrScrH:GetInt(), RT_SIZE_DEFAULT,MATERIAL_RT_DEPTH_SHARED,16,CREATERENDERTARGETFLAGS_AUTOMIPMAP,IMAGE_FORMAT_DEFAULT)
