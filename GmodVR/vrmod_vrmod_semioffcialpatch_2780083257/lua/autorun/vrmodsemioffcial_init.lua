...
-- ConVarの値を取得
local excludedFilesString = GetConVarString("vrmod_dev_excluded_files")
local excludedFiles = {}
...
-- -- ConVarを作成
-- CreateConVar("vrmod_dev_included_files", "", FCVAR_ARCHIVE, "Included Lua files separated by semicolons")

-- -- ConVarの値を取得
-- local includedFilesString = GetConVarString("vrmod_dev_included_files")
-- local includedFiles = {}
