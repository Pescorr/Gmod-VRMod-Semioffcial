...
--button toggle start
			...
			function buttonD:Paint(w, h)
				buttonD:SetText("vrgrab_range: "..GetConVar("vrgrab_range"):GetFloat())
				draw.RoundedBox(8, 0, 0, w, h, BUTTON_5TIER[buttonDon+1])
			end
--button toggle end
